...
@section('title','小米后台 - 添加管理员')
@section('content')
    <div class="mws-panel grid_8">
        <div class="mws-panel-header">
            <span><i class="icon-add-contact"></i> 添加管理员</span>
        </div>
        <div class="mws-panel-body no-padding">
            <form class="mws-form wzd-ajax" action="{{ URL('admin/admin') }}" method="post">
                 ...
                 <fieldset class="wizard-step mws-form-inline">
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <ul class="mws-form-list">
                                <li>
                                    <input type="radio" id="female" name="user_type" value='0'/> <label for="female">超级管理员　</label>
                                    <input type="radio" id="male" name="user_type" value='1'/> <label for="male">管理员　</label>
                                </li>
                            </ul>
                            <label class="error plain" generated="true" for="gender" style="display:none"></label>
                        </div>
