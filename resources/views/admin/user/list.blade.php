...
@section('content')
	...
	<div class="mws-panel grid_8">
        ...
        <form name='delForm' action="{{ URL('admin/user') }}" method='post'>
                    ...
                    <tr id="{{ $user->id }}">
                        ...
                        <td>
                            <span class="btn-group">
                                <a href='{{ URL("admin/user/$user->id/edit") }}' class="btn btn-small"><i class="icon-pencil" title='修改'></i></a>
